# RailsAdmin config file. Generated on July 11, 2013 21:21
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['AdminUser', 'BusinessAccount', 'CouponCode', 'Payment', 'SiteConfig']
  ...
  #     configure :special, :serialized 
  #     configure :customer_id, :text 
  #     configure :redeemed_coupons, :serialized 
  ...
  #     configure :confirmation, :text 
  #     configure :charge_id, :text 
  #     configure :amount, :integer 
  #     configure :recorded_amount, :integer 
  #     configure :fingerprint, :text 
  #     configure :coupon_id, :text 
  #     configure :customer_id, :text 
  #     configure :provider, :text 
  #     configure :raw_log, :text 
  #     configure :business_account_id, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your site_config.rb model definition
  ...
  #     configure :_id, :bson_object_id 
  #     configure :accept_promos, :boolean 
  #     configure :default_us_price, :decimal 
  #     configure :default_ca_price, :decimal 
  #     configure :stripe_enabled, :boolean 
  #     configure :paypal_enabled, :boolean 
